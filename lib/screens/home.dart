...
class _HomeState extends State<Home> {
  ...
  void _filterTodo(String filteredText){
    setState(() {
      _filteredTodo = filteredText.isEmpty ? todos: todos.where((element) => element.todoText.toLowerCase().contains(filteredText.toLowerCase())).toList();
    });
  }
  @override
  ...
  AppBar _buildAppBar(BuildContext context){
    return AppBar(
      ...
      title: Row(
        ...
        children: [
          const Text('Todo App' , style: TextStyle(fontSize: 30 , fontWeight: FontWeight.w700 ),),
          Switch(value: Provider.of<ThemeProvider>(context).isDarkMode, onChanged: (bool value){
